...
import com.company.micro.domain.ebook.v1.product.dto.ProductDto;
...
@RestController("Scholar_ProductController_V1")
@RequestMapping("/scholar/v1")
public class ProductController extends com.company.micro.v1.product.ProductController {
    /**
     * Product service.
     */
    ...
    public ProductController(RequestContext requestContext,
                             @Qualifier("Scholar_ProductService_V1") ProductService service,
    ...
    public ResponseEntity<APIResponse> fetchProductById(
        ...
        final APIResponse<Map<String, ProductDto>> apiResponse = new APIResponse.Builder<Map<String, ProductDto>>()
                ...
                .data(Collections.singletonMap("product", new ProductDto(product, "Scholar Custom")))
